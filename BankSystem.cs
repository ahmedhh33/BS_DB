...
namespace BS_DB
{
    public class BankSystem
    {
            ...
            public void UserInfo(string email, string password)
            {
                ...
                try
                {
                    ...
                    string RegisteringUser = "select * from Users where email= @email and userPassword = @password ;";
                    SqlCommand command = new SqlCommand(RegisteringUser, connection);
                    ...
                    while (reader.Read())
                    {
                         ...
                         accountHolderID = reader.GetInt32(reader.GetOrdinal("userID"));
                        string UseName = reader.GetString(reader.GetOrdinal("userName"));

                        Console.WriteLine($"UserID :{accountHolderID} User Name: {UseName} ");
                    }
            ...
            public void CreateAccount()
            {
                ...
                try
                {
                    ...
                    //int account = GetUserID(accountHolderID);
            ...
            public void Withdraw()
            {
                ...
                try
                {
                    ...
                    string Updatebalance = "Update accounts set balance = balance - @amount where balance>@amount and accountsNumber = @accountNumber and userID = @accountHolderID ";
                    SqlCommand Command = new SqlCommand(Updatebalance, connection);
                    Command.Parameters.AddWithValue("@amount", amount);
                    Command.Parameters.AddWithValue("@accountNumber", accountNumber);
                    Command.Parameters.AddWithValue("@accountHolderID", accountHolderID);
                ...
                try
                {
                    ...
                    if (sourceAccount > 0 || targetAccount > 0)
                    {
                        ...
                        Console.WriteLine("one of accounts wrong");
                           ...
                           string Updatebalance = "Update accounts set balance = balance - @amount where balance>@amount and accountsNumber = @sourceAccountNumber  and userID = @accountHolderID";
